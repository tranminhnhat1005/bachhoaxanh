...
import addOneClass from '../../utils/react-transition-group/addClass';

import removeOneClass from '../../utils/react-transition-group/removeClass';
...
const removeClass = (node, classes) =>
  node &&
  classes &&
  classes.split (' ').forEach (c => removeOneClass (node, c));
