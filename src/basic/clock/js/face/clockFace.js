...
export default class ClockFace {
	...
	initViews() {
		...
		this.clockElem.onmousemove = (e) =>
			this.selectTime(e, false, this.clockElem);
		this.clockElem.onclick = (e) =>
			this.selectTime(e, true, this.clockElem);

		this.innerClockElem.onmousemove = (e) =>
			this.selectTime(e, false, this.innerClockElem);
		this.innerClockElem.onclick = (e) =>
			this.selectTime(e, true, this.innerClockElem);
	}
	...
	initTimeFaces(initialTime) {
		this.minutesFace = new MinutesFace(
			...
			initialTime.minutes,
			(minutes, angle) => this.updateMinutes(minutes, angle),
		);
		...
		this.hoursFace = new HoursFace(
			...
			initialTime.hours,
			(hours, angle, radius) => this.updateHours(hours, angle, radius),
		);
	}
	...
	createFace() {
		const clockFaceCreator = new ClockFaceCreator(
			this.clockElem,
			this.innerClockElem,
		);
		clockFaceCreator.create(
			this.clockItems,
			this.innerClockItems,
			this.outerClockItems,
			this.hoursFace,
		);
		clockFaceCreator.calculateSize(
			this.clockItems,
			this.innerClockItems,
			this.outerClockItems,
		);
