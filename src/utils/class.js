...
const redefine = function (members) {
	...
	for (memberName in members) {
		...
		overridden =
			typeof that.prototype[memberName] === 'function' &&
...
const include = function () {
	...
	const hasClassObjOwnProperty = Object.prototype.hasOwnProperty.bind(
		classObj
	);
	const isES6Class =
...
const subclassOf = function (parentClass) {
	const hasParentProperty = Object.prototype.hasOwnProperty.bind(this)(
		'parent'
	);
