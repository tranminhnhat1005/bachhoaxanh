  ...
  return function createPopper (reference, popper, options = defaultOptions) {
    ...
    const instance = {
      ...
      forceUpdate () {
        ...
        const {reference, popper} = state.elements; // Don't proceed if `reference` or `popper` are not valid elements
        // anymore
        ...
        state.orderedModifiers.forEach (
          modifier =>
            (state.modifiersData[modifier.name] = Object.assign (
              {},
              modifier.data
            ))
        );
...
export const createPopper = /*#__PURE__*/ popperGenerator (); // eslint-disable-next-line import/no-unused-modules
