...
import { getFormatter as getLDMLFormatter } from '../locale/ldml/date.formatter';
import defaultDateNames from '../locale/default_date_names';
...
function parseDate(text) {
	const isDefaultSerializationFormat =
...
function parseISO8601String(text) {
	...
	const parseMilliseconds = function (part) {
		part = part || '';
		return (
			getTimePart(part) * Math.pow(10, MILLISECOND_LENGHT - part.length)
		);
	};
